/// Reduces size of header files
#define WIN32_LEAN_AND_MEAN
#include <Windows.h>
/// Used to parse command line arguments
#include <shellapi.h>

/// min and max macros defined in standard C library headed file may conflict with std::min and std::max functions defined in algoritm STL headed
#if defined(min)
#undef min
#endif
...
/// CreateWindow function is defined in this source file and is in conflic with CreateWindow macro from Windows.h file
#if defined(CreateWindow)
#undef CreateWindow
#endif

/// Contains the definition for ComPtr template class, ComPtr provides smart pointer functionality for COM objects
#include <wrl.h>
...
/// Flag to use WARP adapter, https://docs.microsoft.com/en-us/windows/desktop/direct3darticles/directx-warp#what-is-warp
...
///Flag that is being set only afte all of the DX12 objects have been created
bool g_IsInitialized = false;

/// Window handle
HWND g_hWnd;
/// When entering fullscreen mode old resolution is being saved so the user can revert to in upon exit
RECT g_WindowRect;
...
{
	/*
	* -w --width		-Width of render window
	* -h --height		-Height of render window
	* -warp --warp		-Use WARP for device creation
	*/
	int argc;
